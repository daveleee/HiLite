...
<html>
	<head>
	    ...
	    <script type="text/javascript">
	    	function go_recordboard_write() {
	    		location.href="../php/recordboard_write.php";
	    	};
	    	function go_back() {
	...
	<div id="controls">
		<img id="record" src="../img/icon/mic.png" onclick="toggleRecording(this);">
		<a href="#" id="save">
	        <img src="../img/icon/save31.png">
	    </a>
	    <button type="button" onclick="go_recordboard_write()" class="btn btn-default">글작성</button>
	    <button type="button" onclick="go_back()" class="btn btn-default">이전</button>
	</div>
