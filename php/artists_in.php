...
?>
    <option value="./artists_in.php?mus_ename=<?php echo $row1['mus_ename'] ?>">
      <?php
        echo $row1['mus_ename'];
      ?>
    </option>
...
?>
						<div class="media">
						  <div class="media-left">
						    <img class="media-object" src="../img/artists/<?php echo $mus_ename; ?>/<?php echo $i; ?>.png" alt="...">
						  </div>
							      	...
							      	<div class="panel-body">
							        	<ul class="brisum2 clearfix" style="padding-left: 0px;">
			    							...
			    							<li style="width: 65%">
			    								<span>
<?php
	$sql6='select distinct song_sname, song_aname from tbl_song, tbl_album 
			where album_ename="'.$mus_ename.'" and song_album_no="'.$mus_ename.''.$i.'" ';
...
?>
			    							...
			    							<li style="width: 30%">
			    								<span>
<?php
	$sql7='select distinct song_sname, song_aname from tbl_song, tbl_album 
			where album_ename="'.$mus_ename.'" and song_album_no="'.$mus_ename.''.$i.'" ';
