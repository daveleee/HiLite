...
<?php
    ...
    $sql='update tbl_freeboard set fb_views=fb_views+1 where fb_no='.$fb_no;
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            $( "#list" ).click(function( event ) {
                location.href='../php/freeboard.php';
            });
...
<!--게시글 내용 푸싱 -->   
<?php
    $sql1='select * from tbl_freeboard where fb_no='.$fb_no;
...
?>
            <div class="det">
                <div class="hgroup">
                    <div class="title">
                        <strong><?php echo $row1['fb_title']; ?></strong>
                    </div>
                    <dl>
                        <dt>
                            <span>작성자:<?php echo $row1['fb_id']; ?></span>
                            <span>조회수:<?php echo $row1['fb_views']; ?></span>
                        </dt>
                        <dd>
                            <span><?php echo $row1['fb_date']; ?></span>
                        </dd>
                    </dl>
                </div>
                <div id="conbody" class="conbody">
                    <?php echo $row1['fb_text']; ?>
                </div>
