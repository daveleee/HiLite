...
<html>
	<head>
	    ...
	    <script type="text/javascript">
	    	function go_freeboard() {
	    		location.href="./admin_freeboard.php";
	    	}
	    </script>
	</head>
    ...
    <div id="scbd" class="scbd mo">
    	...
    	<form name="frmWrite" action="add_db_admin_freeboard.php" method="post">
		    <div class="write">
		    	<fieldset>
				...
				<dl>
					...
					<dd>
						<span class="ui-input ipt-block">
							<input type="text" class="form-control" name="ftitle" value=""/>
						</span>					
					</dd>
				</dl>
				...
				<dl>
					...
					<dd>
						<span class="ui-input">
							<textarea class="form-control" name="ftext" rows="5"></textarea>
						</span>
					</dd>
				</dl>
				...
				<div class="write_button">
					...
					<button type="button" onclick="go_freeboard()" class="btn btn-default">취소</button>
				</div>
