...
?>
    			<form name="member-form" action="./add_db_notice.php" method="post" class="admin-member-form">
    				<ul>
    					<li>
    						<label for="subject">제목</label>
    						<input type="text" class="form-control" name="ftitle" id="notice_subject" />
    					</li>
    					<li>
    						<label for="content">내용</label>
    						<textarea class="form-control" name="ftext" rows="50"></textarea>
    					</li>
    					<li>
