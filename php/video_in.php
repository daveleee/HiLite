...
<html>
    ...
    <select class="form-control" onchange="go_url(this.options[this.selectedIndex].value)">
  	  <option value="./video.php">가수를 선택하세요.</option>
	  <option value="./video.php">ALL</option>
<?php
...
?>
	  <option value="./video_in.php?mus_ename=<?php echo $row1['mus_ename']; ?>">
	  	<?php
	  		echo $row1['mus_ename'];
	  	?>
	  </option>
...
?>
   	<div class="video_wrap">
   		<div class="embed-responsive embed-responsive-16by9" >
		  	<iframe class="embed-responsive-item" src="<?php echo $row2['vid_vidpath']; ?>"></iframe>
		</div>
		<span><?php echo $row2['vid_name']; ?></span>
		<span><?php echo $row2['vid_date']; ?></span>
	</div>
	<hr>
<?php
	}
