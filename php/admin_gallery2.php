...
<html>
	<head>
	    ...
	    <script type="text/javascript">
	    	...
	    	function gowrite()
	    	{
	    		location.href="./admin_gallery_write.php";
	    	}
	    </script>
	</head>
...
<!--옵션 -->   
    <select class="form-control" onchange="go_url(this.options[this.selectedIndex].value)">
	  <option value="./admin_gallery.php">가수를 선택하세요.</option>
<?php
	$sql2='select * from tbl_gallery where gal_name="all"';
	$result2=mysqli_query($conn, $sql2);
	$row2=mysqli_fetch_assoc($result2);
?>
	  <option value="./admin_gallery2.php?mus_ename=<?php echo $row2['gal_name']; ?>">ALL</option>
<?php
...
?>
	  <option value="./admin_gallery2.php?mus_ename=<?php echo $row1['mus_ename']; ?>">
	  	<?php
	  		echo $row1['mus_ename'];
	  	?>
	  </option>
    	...
    	<div id="scbd" class="scbd co-red mo">
    		<div id="lay-hd" class="lay-hd">
    			<div class="hgroup">
    				...
    				<ul>
    					<li>
    						<button type="button" onClick="gowrite()" class="btn btn-link" target="self" style="color:#ffffff; width:100%; height: 100%;">
...
?>
	    					...
	    					<div class="td col_subject">
	    						<div style="padding-left:0px;">
	    							<a href="./admin_gallery_in.php?mus_ename=<?php echo $row2['gal_name']; ?>&gal_no=<?php echo $row2['gal_no']; ?>">
	    								<span>
<?php
	echo $row2['gal_date'];
?>
